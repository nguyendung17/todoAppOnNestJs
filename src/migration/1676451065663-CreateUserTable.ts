...
export class CreateUserTable1676451065663 implements MigrationInterface {
    name = 'CreateUserTable1676451065663'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_info" ("id" SERIAL NOT NULL, "pet_name" character varying, "photo" character varying, "modified_photo" character varying, "address" character varying NULL, CONSTRAINT "PK_273a06d6cdc2085ee1ce7638b24" PRIMARY KEY ("id"))`);
